...
// Chapter: Graphics / Output
// Short Description: Call disp_object_model_3d and a fallback solution if there is no OpenGL Available. 
    ...
    HTuple hv_CamParam, HTuple hv_Pose, HTuple hv_GenParamName, HTuple hv_GenParamValue)
{
  ...
  catch (HException &HDevExpDefaultException)
  {
    ...
    if (0 != (int((hv_Pose.TupleLength())==0)))
    {
    ...
    else if (0 != (int((hv_Pose.TupleLength())==7)))
    {
      hv_Poses = HTuple();
      hv_HomMat3Ds = HTuple();
      hv_Sequence = HTuple::TupleGenSequence(0,(hv_NumModels*7)-1,1);
    ...
    {
      if (0 != (int((hv_Pose.TupleLength())!=((hv_ObjectModel3D.TupleLength())*7))))
      {
    ...
    {
      if (0 != (int(HTuple(hv_GenParamValue[hv_Indices])==HTuple("true"))))
      {
