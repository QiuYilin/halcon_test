...
// Chapter: Calibration / Camera Parameters
// Short Description: Generate a camera parameter tuple for a line scan camera with distortions modeled by the division model. 
void gen_cam_par_line_scan_division (HTuple hv_Focus, HTuple hv_Kappa, HTuple hv_Sx, 
    HTuple hv_Sy, HTuple hv_Cx, HTuple hv_Cy, HTuple hv_ImageWidth, HTuple hv_ImageHeight, 
    HTuple hv_Vx, HTuple hv_Vy, HTuple hv_Vz, HTuple *hv_CameraParam);
// Chapter: Calibration / Camera Parameters
// Short Description: Generate a camera parameter tuple for a line scan camera with distortions modeled by the polynomial model. 
void gen_cam_par_line_scan_polynomial (HTuple hv_Focus, HTuple hv_K1, HTuple hv_K2, 
    HTuple hv_K3, HTuple hv_P1, HTuple hv_P2, HTuple hv_Sx, HTuple hv_Sy, HTuple hv_Cx, 
    HTuple hv_Cy, HTuple hv_ImageWidth, HTuple hv_ImageHeight, HTuple hv_Vx, HTuple hv_Vy, 
    HTuple hv_Vz, HTuple *hv_CameraParam);
// Chapter: Calibration / Camera Parameters
// Short Description: Generate a camera parameter tuple for a line scan camera with a telecentric lens and with distortions modeled by the division model. 
void gen_cam_par_line_scan_telecentric_division (HTuple hv_Magnification, HTuple hv_Kappa, 
    HTuple hv_Sx, HTuple hv_Sy, HTuple hv_Cx, HTuple hv_Cy, HTuple hv_ImageWidth, 
    HTuple hv_ImageHeight, HTuple hv_Vx, HTuple hv_Vy, HTuple hv_Vz, HTuple *hv_CameraParam);
// Chapter: Calibration / Camera Parameters
// Short Description: Generate a camera parameter tuple for a line scan camera with a telecentric lens and with distortions modeled by the polynomial model. 
void gen_cam_par_line_scan_telecentric_polynomial (HTuple hv_Magnification, HTuple hv_K1, 
    HTuple hv_K2, HTuple hv_K3, HTuple hv_P1, HTuple hv_P2, HTuple hv_Sx, HTuple hv_Sy, 
    HTuple hv_Cx, HTuple hv_Cy, HTuple hv_ImageWidth, HTuple hv_ImageHeight, HTuple hv_Vx, 
    HTuple hv_Vy, HTuple hv_Vz, HTuple *hv_CameraParam);
// Chapter: Calibration / Camera Parameters
    ...
    HTuple hv_Vx, HTuple hv_Vy, HTuple hv_Vz, HTuple *hv_CameraParam)
{
  ...
  //
  (*hv_CameraParam).Clear();
  (*hv_CameraParam)[0] = "line_scan_division";
  (*hv_CameraParam).Append(hv_Focus);
  (*hv_CameraParam).Append(hv_Kappa);
  (*hv_CameraParam).Append(hv_Sx);
  (*hv_CameraParam).Append(hv_Sy);
    ...
    HTuple hv_Vz, HTuple *hv_CameraParam)
{
  ...
  //
  (*hv_CameraParam).Clear();
  (*hv_CameraParam)[0] = "line_scan_polynomial";
  (*hv_CameraParam).Append(hv_Focus);
  (*hv_CameraParam).Append(hv_K1);
  (*hv_CameraParam).Append(hv_K2);
  (*hv_CameraParam).Append(hv_K3);
    ...
    HTuple hv_ImageHeight, HTuple hv_Vx, HTuple hv_Vy, HTuple hv_Vz, HTuple *hv_CameraParam)
{
  ...
  //Generate a camera parameter tuple for a telecentric line scan camera
  //with distortions modeled by the division model.
  //
  (*hv_CameraParam).Clear();
  (*hv_CameraParam)[0] = "line_scan_telecentric_division";
  (*hv_CameraParam).Append(hv_Magnification);
  (*hv_CameraParam).Append(hv_Kappa);
  (*hv_CameraParam).Append(hv_Sx);
  (*hv_CameraParam).Append(hv_Sy);
    ...
    HTuple hv_Vy, HTuple hv_Vz, HTuple *hv_CameraParam)
{
  ...
  //
  (*hv_CameraParam).Clear();
  (*hv_CameraParam)[0] = "line_scan_telecentric_polynomial";
  (*hv_CameraParam).Append(hv_Magnification);
  (*hv_CameraParam).Append(hv_K1);
  (*hv_CameraParam).Append(hv_K2);
  (*hv_CameraParam).Append(hv_K3);
