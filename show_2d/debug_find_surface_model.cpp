...
// Chapter: 3D Matching / 3D Box
void check_find_box_3d_params (HTuple hv_WindowHandle, HTuple hv_ObjectModel3DBox, 
    HTuple hv_ObjectModel3DScene, HTuple hv_BoxInformation);
...
// Chapter: 3D Matching / Surface-Based
void check_visibility (HTuple hv_WindowHandle1, HTuple hv_WindowHandle2, HTuple hv_SurfaceModelID, 
    HTuple hv_ObjectModel3DScene, HTuple hv_ObjectModel3DModel, HTuple hv_SurfaceMatchingResultID, 
    HTuple hv_ViewpointIn, HTuple *hv_Viewpoint);
// Chapter: System / Multithreading
void create_visualization_message_queues (HTuple *hv_MessageQueues);
// Chapter: 3D Matching / 3D Box
// Short Description: Inspect the parameters for the generic box finder. 
void debug_find_box_3d (HTuple hv_ObjectModel3DBox, HTuple hv_ObjectModel3DScene, 
    HTuple hv_BoxInformation, HTuple *hv_FindBox3DGenParam);
// Chapter: 3D Matching / Surface-Based
...
// Short Description: Close the window if it is still open. 
void dev_close_window_if_open (HTuple hv_WindowHandle);
// Chapter: 3D Matching / 3D Box
void dev_display_find_box_3d_results (HTuple hv_WindowHandle1, HTuple hv_BoxInformation, 
    HTuple hv_ObjectModel3DBox, HTuple hv_ObjectModel3DScene, HTuple hv_Score, HTuple hv_Pose);
// Chapter: 3D Matching / Surface-Based
void dev_display_surface_matching_results (HTuple hv_WindowHandle1, HTuple hv_SurfaceMatchingResultID, 
    ...
    HTuple hv_Pose, HTuple hv_EdgesTrained, HTuple hv_VisibilityTrained);
// Chapter: Graphics / Output
// Short Description: Display buttons in a window. 
...
void disp_menu_ext (HObject ho_MenuRegions, HTuple hv_WindowHandleMenu, HTuple hv_MenuText, 
    HTuple hv_CasesDone, HTuple hv_CurrentCase, HTuple hv_WindowScaling);
// Chapter: Graphics / Output
...
// Chapter: Graphics / Output
void estimate_visualization_pose_object_model_3d (HTuple hv_ObjectModel3D, HTuple hv_WindowHandle, 
...
// Chapter: 3D Matching / Surface-Based
void get_aggregated_models_diameter (HTuple hv_ObjectModel3DBox, HTuple *hv_ModelDiameterAggregated);
...
// Chapter: 3D Matching / Surface-Based
void get_max_min_amplitude (HTuple hv_BoxInformation, HTuple *hv_MaxMinAmplitude);
// Chapter: 3D Matching / Surface-Based
void get_min_amplitude (HTuple hv_BoxInformation, HTuple *hv_MinAmplitude);
// Chapter: Graphics / Mouse
...
void inspect_normal_direction (HObject ho_MenuRegions, HTuple hv_WindowHandle1, HTuple hv_WindowHandle2, 
    ...
    HTuple hv_WindowScaling, HTuple *hv_CreateNames, HTuple *hv_CreateValues, HTuple *hv_FindNames, 
    HTuple *hv_FindValues);
// Chapter: 3D Object Model / Features
void inspect_scene_edge_directions (HTuple hv_WindowHandle1, HTuple hv_SurfaceModelID, 
    HTuple hv_ObjectModel3DScene, HTuple hv_SurfaceMatchingResultID, HTuple hv_MaxGapIn, 
    HTuple hv_MinAmplitudeIn);
// Chapter: 3D Object Model / Features
void inspect_scene_edge_parameters (HTuple hv_WindowHandle1, HTuple hv_WindowHandle2, 
    ...
    HTuple hv_MaxGapIn, HTuple hv_MinAmplitudeAbsIn, HTuple *hv_MaxGap, HTuple *hv_MinAmplitudeAbs);
// Chapter: 3D Object Model / Features
void inspect_scene_edge_parameters_find_box_3d (HTuple hv_WindowHandle1, HTuple hv_WindowHandle2, 
    HTuple hv_ObjectModel3DBox, HTuple hv_ObjectModel3DScene, HTuple hv_BoxInformation, 
    HTuple *hv_MaxGapOut, HTuple *hv_MinAmplitude);
// Chapter: Graphics / Output
...
void set_edge_parameter_sliders (HTuple hv_WindowHandle, HTuple hv_ObjectModel3D, 
    ...
    HTuple hv_AmplitudeRange, HTuple hv_MaxGapRange, HTuple hv_SceneNormalsInverted, 
    HTuple *hv_MinAmplitude, HTuple *hv_MaxGap);
// Chapter: Graphics / Output
void set_edge_parameter_sliders_find_box_3d (HTuple hv_WindowHandle, HTuple hv_ObjectModel3DScene, 
    HTuple hv_MessageQueues, HTuple hv_MessageQueueOut, HTuple hv_AmplitudeRange, 
    HTuple hv_MaxGapRange, HTuple hv_GenParamDict, HTuple *hv_MinAmplitude, HTuple *hv_MaxGap);
// Chapter: Graphics / Output
...
// Parallel execution wrapper for set_edge_parameter_sliders_find_box_3d(...) 
static void* _hcppthread_set_edge_parameter_sliders_find_box_3d(void *hcthread);
}
    ...
    HTuple hv_ObjectModel3DScene, HTuple hv_BoxInformation)
{
  ...
  // Local control variables
  HTuple  hv_BoxResultsDict, hv_AllBoxResultsDictKeys;
  HTuple  hv_NumScenePoints, hv_Index, hv_SceneHasMapping;
  HTuple  hv_Exception, hv_SceneHasTriangles, hv_SceneHasPolygons;
  HTuple  hv_PX, hv_PY, hv_PZ, hv_BBox, hv_DiameterScene;
  HTuple  hv_CenterScene, hv_SizesOK, hv_DiameterModel, hv_Index1;
  HTuple  hv_IsNaN, hv_LargeNum, hv_Inf, hv_IsInf, hv_ModelDiameterAggregated;
  HTuple  hv_DistThreshold, hv_NumNeighbors, hv_MaxNumNeighbors;
  HTuple  hv_Pos, hv_Rows, hv_Cols, hv_MappingAsString, hv_NumSparsePoints;
  HTuple  hv_ZSigmaAbs, hv_ZSigmaRel, hv_ZSigmaPct;

  write_note(hv_WindowHandle, "none", "Checking parameters for find_box_3d...");
  NewLine(hv_WindowHandle);
  //*****************************************************************
  //Basic Parameter Checks
  //*****************************************************************
  GetDictTuple(hv_BoxInformation, "results", &hv_BoxResultsDict);
  GetDictParam(hv_BoxResultsDict, "keys", HTuple(), &hv_AllBoxResultsDictKeys);
  hv_NumScenePoints = 0;
  if (0 != (HTuple(int((hv_ObjectModel3DBox.TupleLength())!=(hv_AllBoxResultsDictKeys.TupleLength()))).TupleOr(int((hv_ObjectModel3DScene.TupleLength())!=1))))
  {
    write_note(hv_WindowHandle, "error", "Invalid number of boxes or scenes.");
  }
  else
  {
    {
    HTuple end_val11 = (hv_AllBoxResultsDictKeys.TupleLength())-1;
    HTuple step_val11 = 1;
    for (hv_Index=0; hv_Index.Continue(end_val11, step_val11); hv_Index += step_val11)
    {
      try
      {
        GetObjectModel3dParams(HTuple(hv_ObjectModel3DBox[hv_Index]), "has_xyz_mapping", 
            &hv_SceneHasMapping);
        GetObjectModel3dParams(HTuple(hv_ObjectModel3DBox[hv_Index]), "num_points", 
            &hv_NumScenePoints);
      }
      // catch (Exception) 
      catch (HException &HDevExpDefaultException)
      {
        HDevExpDefaultException.ToHTuple(&hv_Exception);
        write_note(hv_WindowHandle, "error", ("Invalid box model at Index "+hv_Index)+" (not a valid 3D object model handle).");
      }
    }
    }
    try
    {
      GetObjectModel3dParams(hv_ObjectModel3DScene, "has_xyz_mapping", &hv_SceneHasMapping);
      GetObjectModel3dParams(hv_ObjectModel3DScene, "has_triangles", &hv_SceneHasTriangles);
      GetObjectModel3dParams(hv_ObjectModel3DScene, "has_polygons", &hv_SceneHasPolygons);
  ...
  //*****************************************************************
  hv_SizesOK = 1;
  GetObjectModel3dParams(hv_ObjectModel3DBox, "diameter", &hv_DiameterModel);
  //
  {
  HTuple end_val52 = (hv_ObjectModel3DBox.TupleLength())-1;
  HTuple step_val52 = 1;
  for (hv_Index1=0; hv_Index1.Continue(end_val52, step_val52); hv_Index1 += step_val52)
  {
    if (0 != (int(hv_DiameterModel>(hv_DiameterScene*3))))
    {
      write_note(hv_WindowHandle, "warning", ("The diameter of model "+hv_Index)+" is very large (3 times the scene diameter).");
      hv_SizesOK = 0;
    }
    if (0 != (int(hv_DiameterModel<(hv_DiameterScene/30))))
    {
      write_note(hv_WindowHandle, "warning", ("The diameter of model "+hv_Index)+" is very small (<3% of the scene diameter).");
      hv_SizesOK = 0;
    }
  }
  }
  ...
  //*****************************************************************
  get_aggregated_models_diameter(hv_ObjectModel3DBox, &hv_ModelDiameterAggregated);
  hv_DistThreshold = hv_ModelDiameterAggregated*1e-7;
  if (0 != (int(hv_NumScenePoints>0)))
  {
  ...
  //*****************************************************************
  if (0 != (int(hv_SceneHasMapping==HTuple("true"))))
  {
  ...
  //*****************************************************************
  if (0 != (HTuple(int(hv_SceneHasTriangles==HTuple("true"))).TupleOr(int(hv_SceneHasPolygons==HTuple("true")))))
  {
    write_note(hv_WindowHandle, "warning", HTuple("Scene contains a mesh (triangles or polygons). ")+HTuple("Meshes are ignored, and only the 3D points are used during finding boxes."));
  }
  else
  {
  ...
  if (0 != (int(hv_NumScenePoints>0)))
  {
    hv_DistThreshold = hv_ModelDiameterAggregated*0.05;
    GetObjectModel3dParams(hv_ObjectModel3DScene, "num_neighbors_fast "+hv_DistThreshold, 
        &hv_NumNeighbors);
  ...
  //*****************************************************************
  //Does the scene contain a mapping?
  //*****************************************************************
  if (0 != (int(hv_SceneHasMapping==HTuple("false"))))
  {
    write_note(hv_WindowHandle, "error", HTuple("Scene does not contain XYZ-Mapping, which is required for ")+"the box finder.  Create the scene with xyz_to_object_model_3d instead.");
  }
  else
  {
  ...
  //*****************************************************************
  if (0 != (HTuple(int(hv_SceneHasMapping==HTuple("true"))).TupleAnd(int(hv_ModelDiameterAggregated>0))))
  {
    ObjectModel3dToXyz(&ho_X, &ho_Y, &ho_Z, hv_ObjectModel3DScene, "from_xyz_map", 
        HTuple(), HTuple());
    estimate_noise_real(ho_Z, 0.05, &hv_ZSigmaAbs);
    hv_ZSigmaRel = hv_ZSigmaAbs/hv_ModelDiameterAggregated;
    hv_ZSigmaPct = ((hv_ZSigmaRel*100).TupleString(".2"))+"%";
    if (0 != (int(hv_ZSigmaRel>0.2)))
    {
      write_note(hv_WindowHandle, "error", (("The noise in the data is very high (relative value: "+hv_ZSigmaPct)+"). ")+"Consider smoothing the Z-image with a median filter.");
    }
    else if (0 != (int(hv_ZSigmaRel>0.1)))
    {
      write_note(hv_WindowHandle, "warning", (("The noise in the data seems rather high (relative value: "+hv_ZSigmaPct)+"). ")+"Consider smoothing the Z-image with a median filter.");
    }
    else
    {
  ...
  else
  {
    ...
    write_note(hv_WindowHandle, "info", "Noise was not checked (requires XYZ mapping and found matches).");
  }
  //
  //*****************************************************************
  //DONE
    ...
    HTuple hv_ObjectModel3DScene, HTuple hv_GenParamNames, HTuple hv_GenParamValues)
{
  ...
  // Local control variables
  HTuple  hv_NumScenePoints, hv_DiameterModel, hv_Exception;
  ...
  HTuple  hv_EdgesTrained, hv_ViewBasedTrained, hv_CenterModel;
  HTuple  hv_HasCamPar, hv_CamPar, hv_SizesOK, hv_IsNaN, hv_LargeNum;
  HTuple  hv_Inf, hv_IsInf, hv_DistThreshold, hv_NumNeighbors;
  HTuple  hv_MaxNumNeighbors, hv_Pos, hv_MedianDensity, hv_MLSNormals;
  ...
  HTuple  hv_CenterToDiameter, hv_NumSparsePoints, hv_DistanceOriginRel;
  ...
  GetSurfaceModelParam(hv_SurfaceModel, "view_based_trained", &hv_ViewBasedTrained);
  ...
  else if (0 != (HTuple(int(hv_HasMapping==HTuple("true"))).TupleAnd(int(hv_EdgesTrained==HTuple("true")))))
  {
  ...
  //the normals from the mapping without orientation w.r.t. the mapping
  //*****************************************************************
  if (0 != (HTuple(HTuple(int(hv_HasPointNormals==HTuple("false"))).TupleAnd(int(hv_HasMapping==HTuple("true")))).TupleAnd(int(hv_EdgesTrained==HTuple("false")))))
  {
  ...
  //*****************************************************************
  //Check if the viewpoint is inside the data AND we use the view-based score
  //*****************************************************************
  if (0 != (int(hv_ViewBasedTrained==HTuple("true"))))
  {
    ...
    if (0 != (HTuple(HTuple(HTuple(HTuple(HTuple(int(HTuple(hv_BBox[0])<HTuple(hv_Viewpoint[0]))).TupleAnd(int(HTuple(hv_BBox[1])<HTuple(hv_Viewpoint[1])))).TupleAnd(int(HTuple(hv_BBox[2])<HTuple(hv_Viewpoint[2])))).TupleAnd(int(HTuple(hv_BBox[3])>HTuple(hv_Viewpoint[0])))).TupleAnd(int(HTuple(hv_BBox[4])>HTuple(hv_Viewpoint[1])))).TupleAnd(int(HTuple(hv_BBox[5])>HTuple(hv_Viewpoint[2])))))
    {
      write_note(hv_WindowHandle, "warning", ((HTuple("The viewpoint is inside the scene data. This could be problematic, when the view-based score is used. The distance from scene center to the viewpoint is ~")+(hv_DistanceOriginRel.TupleString(".1f")))+" times the model diameter. ")+"Consider moving the viewpoint origin to the original viewpoint of the sensor.");
    }
    else
    {
      write_note(hv_WindowHandle, "ok", ("Viewpoint is not inside scene data. The distance from scene center to viewpoint is ~"+(hv_DistanceOriginRel.TupleString(".1f")))+" times the model diameter. ");
    }
  }
    ...
    HTuple hv_WindowHandleVisualization)
{
  ...
  //
  hv_Instructions[0] = "Rotate: Left mouse button";
  hv_Instructions[1] = "Zoom:   Shift + left mouse button";
  hv_Instructions[2] = "Move:   Ctrl  + left mouse button";
  //
  ...
  //
  //Find a pose for the second window such that both the model and the camera are visible,
  //from the side.
    ...
    HTuple hv_ViewpointIn, HTuple *hv_Viewpoint)
{
  ...
  // Local control variables
  HTuple  hv_CenterScene, hv_DiameterScene, hv_NumPointsScene;
  ...
  HTuple  hv_ObjectModel3DSceneVis, hv_ObjectModel3DModelSampled;
  HTuple  hv_CenterModel, hv_PoseTranslate, hv_PoseResult;
  HTuple  hv_PoseResultTranslate, hv_PoseTrans, hv_PoseInvert;
  HTuple  hv_PoseInverOnlyRot, hv_HomMat3DOnlyRot, hv_ViewDirScene;
  HTuple  hv_ViewDirModelX, hv_ViewDirModelY, hv_ViewDirModelZ;
  HTuple  hv_norm, hv_ViewDirModel, hv_ViewDirStr, hv_VisibleReferencePoints;
  HTuple  hv_ObjectModel3DVisible, hv_ObjectModel3DModelInPose;
  HTuple  hv_Exception, hv_CenterSceneGravity, hv_OM3DCamera;
  HTuple  hv_OM3DLineSphereToScene, hv_DirectionLength, hv_DirNorm;
  HTuple  hv_ViewpointAsPoseIn, hv_AngleToX, hv_Axis, hv_AxisNorm;
  HTuple  hv_OrthogonalDirection, hv_RotationAxis, hv_DirectionProjected;
  ...
  HTuple  hv_PoseIn, hv_VizposeIn, hv_ShowVisiblePoints, hv_ShowTrainedModel;
  HTuple  hv_MessageQueues2, hv_PreviousState2, hv_ButtonPressed;
  HTuple  hv_Pose, hv_MessageHandle, hv_HomMat3D, hv_HomMat3DInvert;
  HTuple  hv_Qx, hv_Qy, hv_Qz, hv_DidFinish2, hv_Poses, hv_ObjectModel3DNoPoints;
  HTuple  hv_TIT;
  HTupleVector  hvec_TI(1);
  ...
  try
  {
    ...
    //Visualize the sampled scene if the number of scene points
    //exceeds half a million to speed-up the visualization.
    if (0 != (int(hv_NumPointsScene>5e5)))
    {
      CopyObjectModel3d(hv_ObjectModel3DSceneSampled, "all", &hv_ObjectModel3DSceneVis);
    }
    else
    {
      CopyObjectModel3d(hv_ObjectModel3DScene, "all", &hv_ObjectModel3DSceneVis);
    }
    GetSurfaceModelParam(hv_SurfaceModelID, "sampled_model", &hv_ObjectModel3DModelSampled);
    //Get the center of the model and correct the found pose to be consistent with the internal poses
    GetObjectModel3dParams(hv_ObjectModel3DModel, "center", &hv_CenterModel);
    CreatePose(HTuple(hv_CenterModel[0]), HTuple(hv_CenterModel[1]), HTuple(hv_CenterModel[2]), 
        0, 0, 0, "Rp+T", "gba", "point", &hv_PoseTranslate);
    GetSurfaceMatchingResult(hv_SurfaceMatchingResultID, "pose", 0, &hv_PoseResult);
    PoseCompose(hv_PoseResult, hv_PoseTranslate, &hv_PoseResultTranslate);
    //Take the translation part
    hv_PoseTrans = hv_PoseResultTranslate.TupleSelectRange(0,2);
    //Calculate inverse pose
    PoseInvert(hv_PoseResultTranslate, &hv_PoseInvert);
    //We only need the rotation part of the pose
    hv_PoseInverOnlyRot = hv_PoseInvert;
    hv_PoseInverOnlyRot[HTuple::TupleGenSequence(0,2,1)] = 0.0;
    PoseToHomMat3d(hv_PoseInverOnlyRot, &hv_HomMat3DOnlyRot);
    //Calculate the viewing direction in the scene
    hv_ViewDirScene = hv_PoseTrans-(*hv_Viewpoint);
    //Get the viewing direction in the model
    AffineTransPoint3d(hv_HomMat3DOnlyRot, HTuple(hv_ViewDirScene[0]), HTuple(hv_ViewDirScene[1]), 
        HTuple(hv_ViewDirScene[2]), &hv_ViewDirModelX, &hv_ViewDirModelY, &hv_ViewDirModelZ);
    //Normalize the viewing direction
    hv_norm = (((hv_ViewDirModelX*hv_ViewDirModelX)+(hv_ViewDirModelY*hv_ViewDirModelY))+(hv_ViewDirModelZ*hv_ViewDirModelZ)).TupleSqrt();
    hv_ViewDirModel[0] = hv_ViewDirModelX/hv_norm;
    hv_ViewDirModel[1] = hv_ViewDirModelY/hv_norm;
    hv_ViewDirModel[2] = hv_ViewDirModelZ/hv_norm;
    hv_ViewDirStr = (((HTuple(hv_ViewDirModel[0])+" ")+HTuple(hv_ViewDirModel[1]))+" ")+HTuple(hv_ViewDirModel[2]);
    GetSurfaceModelParam(hv_SurfaceModelID, "visible_reference_points "+hv_ViewDirStr, 
        &hv_VisibleReferencePoints);
    RigidTransObjectModel3d(hv_VisibleReferencePoints, hv_PoseResult, &hv_ObjectModel3DVisible);
    RigidTransObjectModel3d(hv_ObjectModel3DModelSampled, hv_PoseResult, &hv_ObjectModel3DModelSampled);
    RigidTransObjectModel3d(hv_ObjectModel3DModel, hv_PoseResult, &hv_ObjectModel3DModelInPose);
  }
  // catch (Exception) 
  catch (HException &HDevExpDefaultException)
  {
    HDevExpDefaultException.ToHTuple(&hv_Exception);
    //Unable to get the visible points -> create a dummy 3D object model instead
    GenEmptyObjectModel3d(&hv_ObjectModel3DSceneSampled);
    GenEmptyObjectModel3d(&hv_ObjectModel3DVisible);
    GenEmptyObjectModel3d(&hv_ObjectModel3DModelSampled);
    GenEmptyObjectModel3d(&hv_ObjectModel3DModelInPose);
  }
  //
  ...
  {
    //The viewpoint is in the center of the scene.
    //We cannot build a camera pose that looks "onto" the scene when we
    //are in its center. Look into the Z-direction instead.
    hv_Direction.Clear();
    hv_Direction[0] = 0;
    hv_Direction[1] = 0;
    hv_Direction[2] = 1;
  ...
  {
    //We are already looking into the right direction
  ...
  else
  {
    if (0 != (int(((hv_DirNorm*((HTuple(0).Append(0)).Append(-1))).TupleSum())>-0.99999)))
    {
      //Angle between the vectors is > 0.25бу
  ...
  hcppthread_handle->SetInputCtrlParamTuple(1,hv_ObjectModel3DVisible.TupleConcat(hv_ObjectModel3DSceneVis));
  hcppthread_handle->SetInputCtrlParamTuple(2,hv_CameraParam);
  ...
  hcppthread_handle->SetInputCtrlParamTuple(5,((HTuple("green").Append("gray")).Append("true")));
  ...
  //Here, the visible points are visualized
  ...
  //(original) z-axis.
  get_object_models_center(hv_ObjectModel3DScene.TupleConcat(hv_OM3DCamera), &hv_VizCenter);
  ...
  determine_optimum_pose_distance((hv_ObjectModel3DScene.TupleConcat(hv_OM3DCamera)).TupleConcat(hv_ObjectModel3DModelInPose), 
      hv_CameraParam, 0.5, hv_PoseIn, &hv_VizposeIn);
  //
  hv_Buttons.Clear();
  hv_Buttons[0] = "Hide Visible Points";
  hv_Buttons[1] = "left";
  hv_Buttons[2] = "bottom";
  hv_Buttons[3] = -1;
  hv_Buttons[4] = -1;
  hv_Buttons[5] = "Hide Trained Model";
  hv_Buttons[6] = "right";
  hv_Buttons[7] = "bottom";
  hv_Buttons[8] = -1;
  hv_Buttons[9] = -1;
  hv_ShowVisiblePoints = 1;
  hv_ShowTrainedModel = 1;
  create_visualization_message_queues(&hv_MessageQueues2);
  // Create a thread instance
  hcppthread_handle = new HDevThread(hcppthread_context,
              (void*)HDevExportCpp::_hcppthread_visualize_object_model_3d_ext,15,0);
  ...
  hcppthread_handle->SetInputCtrlParamTuple(1,(((hv_ObjectModel3DVisible.TupleConcat(hv_ObjectModel3DModelInPose)).TupleConcat(hv_ObjectModel3DSceneVis)).TupleConcat(hv_OM3DCamera)).TupleConcat(hv_OM3DLineSphereToScene));
  hcppthread_handle->SetInputCtrlParamTuple(2,hv_CameraParam);
  hcppthread_handle->SetInputCtrlParamTuple(3,hv_VizposeIn);
  hcppthread_handle->SetInputCtrlParamTuple(4,((((((((HTuple("color_0").Append("color_1")).Append("color_2")).Append("color_3")).Append("color_4")).Append("alpha_1")).Append("disp_pose")).Append("disp_normals_1")).Append("disp_normals_2")));
  hcppthread_handle->SetInputCtrlParamTuple(5,((((((((HTuple("green").Append("red")).Append("gray")).Append("gray")).Append("white")).Append(0.5)).Append("true")).Append("false")).Append("true")));
  hcppthread_handle->SetInputCtrlParamTuple(6,"Inspect Visible Points");
  ...
  while (0 != (hv_DidFinish1.TupleNot()))
  {
    ...
    if (0 != (int(hv_Pose!=HTuple())))
    {
      ...
      SetMessageTuple(hv_MessageHandle, "type", "replace_object_model");
      SetMessageTuple(hv_MessageHandle, "index", 0);
      SetMessageTuple(hv_MessageHandle, "model", hv_ObjectModel3DVisible);
      EnqueueMessage(HTuple(hv_MessageQueues1[1]), hv_MessageHandle, HTuple(), HTuple());
      //
      gen_camera_facing_scene(hv_ViewpointViz, hv_CenterSceneGravity, hv_DiameterModel*2, 
          &hv_OM3DCamera);
      ...
      catch (HException &HDevExpDefaultException)
      {
        HDevExpDefaultException.ToHTuple(&hv_Exception);
        //Unable to get the visible points -> create a dummy 3D object model instead
        GenEmptyObjectModel3d(&hv_ObjectModel3DScene);
        GenEmptyObjectModel3d(&hv_ObjectModel3DVisible);
      }
      //
      CreateMessage(&hv_MessageHandle);
      SetMessageTuple(hv_MessageHandle, "type", "replace_object_model");
      SetMessageTuple(hv_MessageHandle, "index", ((HTuple(0).Append(3)).Append(4)));
      SetMessageTuple(hv_MessageHandle, "model", (hv_ObjectModel3DVisible.TupleConcat(hv_OM3DCamera)).TupleConcat(hv_OM3DLineSphereToScene));
      EnqueueMessage(HTuple(hv_MessageQueues2[1]), hv_MessageHandle, HTuple(), HTuple());
    }
    ...
    if (0 != (int(hv_ButtonPressed==0)))
    {
      hv_ShowVisiblePoints = hv_ShowVisiblePoints.TupleNot();
      //Toggle visible points
      CreateMessage(&hv_MessageHandle);
      SetMessageTuple(hv_MessageHandle, "type", "replace_object_model");
      SetMessageTuple(hv_MessageHandle, "index", 0);
      if (0 != hv_ShowVisiblePoints)
      {
        SetMessageTuple(hv_MessageHandle, "model", hv_ObjectModel3DVisible);
      }
      else
      {
        GenEmptyObjectModel3d(&hv_ObjectModel3DNoPoints);
        SetMessageTuple(hv_MessageHandle, "model", hv_ObjectModel3DNoPoints);
      }
      EnqueueMessage(HTuple(hv_MessageQueues2[1]), hv_MessageHandle, HTuple(), HTuple());
      CreateMessage(&hv_MessageHandle);
      SetMessageTuple(hv_MessageHandle, "type", "change_button_text");
      ...
      if (0 != hv_ShowVisiblePoints)
      {
        SetMessageTuple(hv_MessageHandle, "text", "Hide Visible Points");
      }
      else
      {
        SetMessageTuple(hv_MessageHandle, "text", "Show Visible Points");
      }
      EnqueueMessage(HTuple(hv_MessageQueues2[1]), hv_MessageHandle, HTuple(), HTuple());
    }
    else if (0 != (int(hv_ButtonPressed==1)))
    {
      hv_ShowTrainedModel = hv_ShowTrainedModel.TupleNot();
      //Toggle viewing direction
      CreateMessage(&hv_MessageHandle);
      SetMessageTuple(hv_MessageHandle, "type", "replace_object_model");
      SetMessageTuple(hv_MessageHandle, "index", 1);
      if (0 != hv_ShowTrainedModel)
      {
        SetMessageTuple(hv_MessageHandle, "model", hv_ObjectModel3DModelInPose);
      }
      else
      {
        GenEmptyObjectModel3d(&hv_ObjectModel3DNoPoints);
      ...
      if (0 != hv_ShowTrainedModel)
      {
        SetMessageTuple(hv_MessageHandle, "text", "Hide Trained Model");
      }
      else
      {
        SetMessageTuple(hv_MessageHandle, "text", "Show Trained Model");
      }
      EnqueueMessage(HTuple(hv_MessageQueues2[1]), hv_MessageHandle, HTuple(), HTuple());
    }
  }
    ...
    HTuple hv_BoxInformation, HTuple *hv_FindBox3DGenParam)
{
  ...
  HTuple  hv_Width, hv_Height, hv_MenuText, hv_MenuCode, hv_TopBottom;
  HTuple  hv_NumCols, hv_NumRows, hv_PercentageHeight, hv_CheckedCase;
  HTuple  hv_Case, hv_RowButtons0, hv_ColumnButtons0, hv_RowButtons1;
  HTuple  hv_ColumnButtons1, hv_MenuBottom, hv_BoxResultsDict;
  HTuple  hv_AllBoxResultsDictKeys, hv_Pose, hv_Score, hv_Index;
  HTuple  hv_CurrResultDict, hv_CurrPose, hv_CurrScore, hv_Exception;
  HTuple  hv_CasesDone, hv_CurrentCase, hv_LastException;
  HTuple  hv_GenParamDict, hv_MaxGap, hv_MinAmplitude, hv_ErrorMessage;
  HTuple  hv_Message, hv_EdgeParamsSet, hv_AllParamKeys, hv_Key;
  HTuple  hv_OldParamValue;
  ...
  hv_HeightMenu = (hv_WindowSize/3)+(hv_FontSize*2);
  //
  ...
  hv_MenuText = "Automatic Value Check";
  hv_MenuCode = "check";
  //Add Edge menu items.
  hv_MenuText = hv_MenuText.TupleConcat("3D Edge Extraction");
  hv_MenuCode = hv_MenuCode.TupleConcat("scene_edge_params");
  //Add Results inspection.
  hv_MenuText = hv_MenuText.TupleConcat("FindBox Results");
  hv_MenuCode = hv_MenuCode.TupleConcat("results");
  //Add Exit menu item.
  hv_MenuText = hv_MenuText.TupleConcat("Exit");
  hv_MenuCode = hv_MenuCode.TupleConcat("exit");
  //
  ...
  //
  //Fetch poses and scores: This acts as a sanity check for input data, too.
  GetDictTuple(hv_BoxInformation, "results", &hv_BoxResultsDict);
  GetDictParam(hv_BoxResultsDict, "keys", HTuple(), &hv_AllBoxResultsDictKeys);
  if (0 != (int((hv_AllBoxResultsDictKeys.TupleLength())>0)))
  {
    try
    {
      hv_Pose = HTuple();
      hv_Score = HTuple();
      {
      HTuple end_val49 = (hv_AllBoxResultsDictKeys.TupleLength())-1;
      HTuple step_val49 = 1;
      for (hv_Index=0; hv_Index.Continue(end_val49, step_val49); hv_Index += step_val49)
      {
        GetDictTuple(hv_BoxResultsDict, hv_Index, &hv_CurrResultDict);
        GetDictTuple(hv_CurrResultDict, "box_pose", &hv_CurrPose);
        hv_Pose = hv_Pose.TupleConcat(hv_CurrPose);
        GetDictTuple(hv_CurrResultDict, "score", &hv_CurrScore);
  ...
  GetDictTuple(hv_BoxInformation, "gen_param", &hv_GenParamDict);
  GetDictTuple(hv_GenParamDict, "max_gap", &hv_MaxGap);
  GetDictTuple(hv_GenParamDict, "3d_edge_min_amplitude", &hv_MinAmplitude);
  //
  while (true)
  {
    ClearWindow(hv_WindowHandleMenu);
    disp_menu_ext(ho_MenuRegions, hv_WindowHandleMenu, hv_MenuText, hv_CasesDone, 
        HTuple(), hv_WindowScaling);
    SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
    ...
    if (0 != (int((hv_AllBoxResultsDictKeys.TupleLength())==0)))
    {
      write_note(hv_WindowHandleMenu, "warning", HTuple("No box was found in this run of find_box_3d. Therefore, not all tests are available."));
    }
    ...
    disp_menu_ext(ho_MenuRegions, hv_WindowHandleMenu, hv_MenuText, hv_CasesDone, 
        hv_CurrentCase, hv_WindowScaling);
    //
    try
    {
      //***************************
      ...
      {
        //Update the visualization of the menu.
        HDevWindowStack::SetActive(hv_WindowHandleMenu);
        SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
        ...
        //
        check_find_box_3d_params(hv_WindowHandle1, hv_ObjectModel3DBox, hv_ObjectModel3DScene, 
            hv_BoxInformation);
        //
      ...
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("scene_edge_params"))))
      {
        ...
        //
        inspect_scene_edge_parameters_find_box_3d(hv_WindowHandle1, hv_WindowHandle2, 
            hv_ObjectModel3DBox, hv_ObjectModel3DScene, hv_BoxInformation, &hv_MaxGap, 
            &hv_MinAmplitude);
        hv_EdgeParamsSet = 1;
        //
        dev_close_window_if_open(hv_WindowHandle1);
      ...
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("results"))))
      {
        ...
        HDevWindowStack::SetActive(hv_WindowHandleMenu);
        SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
        write_note(hv_WindowHandleMenu, "instruction", "Inspect the box finder results below.");
        //
        SetWindowAttr("background_color","black");
        OpenWindow(hv_HeightMenu+50,0,hv_WindowSize,hv_WindowSize,0,"visible","",&hv_WindowHandle1);
        HDevWindowStack::Push(hv_WindowHandle1);
        set_display_font(hv_WindowHandle1, hv_FontSize, "mono", "true", "false");
        //
        dev_display_find_box_3d_results(hv_WindowHandle1, hv_BoxInformation, hv_ObjectModel3DBox, 
            hv_ObjectModel3DScene, hv_Score, hv_Pose);
        //
        dev_close_window_if_open(hv_WindowHandle1);
      }
    }
  ...
  CreateDict(&(*hv_FindBox3DGenParam));
  //Copy the old parameters, but without lengths and min_score.
  GetDictParam(hv_GenParamDict, "keys", HTuple(), &hv_AllParamKeys);
  {
  HTuple end_val172 = (hv_AllParamKeys.TupleLength())-1;
  HTuple step_val172 = 1;
  for (hv_Index=0; hv_Index.Continue(end_val172, step_val172); hv_Index += step_val172)
  {
    hv_Key = HTuple(hv_AllParamKeys[hv_Index]);
    if (0 != (HTuple(int(hv_Key==HTuple("lengths"))).TupleOr(int(hv_Key==HTuple("min_score")))))
    {
      continue;
    }
    else
    {
      GetDictTuple(hv_GenParamDict, hv_Key, &hv_OldParamValue);
      SetDictTuple((*hv_FindBox3DGenParam), hv_Key, hv_OldParamValue);
    }
  }
  }
  //Set the new parameters.
  SetDictTuple((*hv_FindBox3DGenParam), "3d_edge_min_amplitude", hv_MinAmplitude);
  SetDictTuple((*hv_FindBox3DGenParam), "max_gap", hv_MaxGap);
}
    ...
    HTuple *hv_FindSurfaceModelParamValue)
{
  ...
  HTuple  hv_WidthMenu, hv_HeightMenu, hv_WindowHandleMenu;
  HTuple  hv_WindowHandle1, hv_WindowHandle2, hv_Row, hv_Column;
  HTuple  hv_Width, hv_Height, hv_HasEdges, hv_HasViewBased;
  ...
  HTuple  hv_Viewpoint, hv_LastException, hv_UserProvidedEdges;
  HTuple  hv_ModelDiameter, hv_MinAmplitudeRel, hv_OM3DProvidedEdges;
  HTuple  hv_ViewpointStr, hv_NormalParamsSet, hv_ErrorMessage;
  HTuple  hv_Message, hv_CreateName, hv_CreateValue, hv_FindNames;
  HTuple  hv_FindValues, hv_EdgeParamsSet;
  ...
  GetSurfaceModelParam(hv_SurfaceModelID, "view_based_trained", &hv_HasViewBased);
  hv_MenuText = "Automatic Value Check";
  hv_MenuCode = "check";
  //Add Normals menu item
  if (0 != (int((hv_SurfaceMatchingResultID.TupleLength())>0)))
  {
    hv_MenuText = hv_MenuText.TupleConcat("Normal Directions");
    hv_MenuCode = hv_MenuCode.TupleConcat("normals");
  }
  //Add Edge menu items
  if (0 != (int(hv_HasEdges==HTuple("true"))))
  {
    hv_MenuText = hv_MenuText.TupleConcat("Inspect Model Edges");
    hv_MenuCode = hv_MenuCode.TupleConcat("model_edges");

    if (0 != (int((hv_SurfaceMatchingResultID.TupleLength())>0)))
    {
      hv_MenuText = hv_MenuText.TupleConcat((HTuple("3D Edge Extraction").Append("Inspect Scene Edges")));
      hv_MenuCode = hv_MenuCode.TupleConcat((HTuple("scene_edge_params").Append("scene_edge_dirs")));
    }
  }
  //Add view-based menu items
  if (0 != (int(hv_HasViewBased==HTuple("true"))))
  {
    if (0 != (int((hv_SurfaceMatchingResultID.TupleLength())>=0)))
    {
      hv_MenuText = hv_MenuText.TupleConcat("View-Based Check");
      hv_MenuCode = hv_MenuCode.TupleConcat("scene_visibility");
    }
  }
  //Add Results inspection
  if (0 != (int((hv_SurfaceMatchingResultID.TupleLength())>0)))
  {
    hv_MenuText = hv_MenuText.TupleConcat("Matching Results");
    hv_MenuCode = hv_MenuCode.TupleConcat("results");
  }
  //Add Exit menu item
  hv_MenuText = hv_MenuText.TupleConcat("Exit");
  ...
  if (0 != (int((hv_SurfaceMatchingResultID.TupleLength())>0)))
  {
    try
    {
      ...
      hv_Score = HTuple();
      {
      HTuple end_val76 = hv_NumPoses-1;
      HTuple step_val76 = 1;
  ...
  if (0 != (HTuple(int(hv_HasViewBased==HTuple("true"))).TupleAnd(int((hv_SurfaceMatchingResultID.TupleLength())>0))))
  {
    GetSurfaceModelParam(hv_SurfaceModelID, "diameter", &hv_ModelDiameter);
    get_find_parameter(hv_GenParamNames, hv_GenParamValues, "viewpoint", "0 0 0", 
        &hv_ViewpointStr);
    ...
    try
    {
      ...
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("normals"))))
      {
        ...
        inspect_normal_direction(ho_MenuRegions, hv_WindowHandle1, hv_WindowHandle2, 
            ...
            hv_FontSize, hv_WindowScaling, &hv_CreateName, &hv_CreateValue, &hv_FindNames, 
            &hv_FindValues);
      ...
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("scene_edge_dirs"))))
      {
        ...
        HDevWindowStack::SetActive(hv_WindowHandleMenu);
        SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
        write_note(hv_WindowHandleMenu, "instruction", HTuple(HTuple("Inspect the viewing and edge directions extracted from the scene. ")+"The viewing directions show away from the viewpoint. ")+"The edge directions should be perpendicular to the edges and point outward.");
        //
        SetWindowAttr("background_color","black");
        OpenWindow(hv_HeightMenu+50,0,hv_WindowSize,hv_WindowSize,0,"visible","",&hv_WindowHandle1);
        HDevWindowStack::Push(hv_WindowHandle1);
        set_display_font(hv_WindowHandle1, hv_FontSize, "mono", "true", "false");
        //
        inspect_scene_edge_directions(hv_WindowHandle1, hv_SurfaceModelID, hv_ObjectModel3DScene, 
            hv_SurfaceMatchingResultID, hv_MaxGap, hv_MinAmplitudeAbs);
        //
        dev_close_window_if_open(hv_WindowHandle1);
      }
      //
      ...
      //***************************
      //
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("scene_visibility"))))
      {
        //Update the visualization of the menu
        HDevWindowStack::SetActive(hv_WindowHandleMenu);
        SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
        write_note(hv_WindowHandleMenu, "info", "This tool allows to inspect the scene visibility.");
        write_note(hv_WindowHandleMenu, "instruction", "Use the left window to move the viewpoint and the right window to inspect the visibility.");
        //
        SetWindowAttr("background_color","black");
        OpenWindow(hv_HeightMenu+50,0,hv_WindowSize,hv_WindowSize,0,"visible","",&hv_WindowHandle1);
        HDevWindowStack::Push(hv_WindowHandle1);
        ...
        set_display_font(hv_WindowHandle2, hv_FontSize, "mono", "true", "false");
        //
        check_visibility(hv_WindowHandle1, hv_WindowHandle2, hv_SurfaceModelID, hv_ObjectModel3DScene, 
            hv_ObjectModel3DModel, hv_SurfaceMatchingResultID, hv_Viewpoint, &hv_Viewpoint);
        //
        dev_close_window_if_open(hv_WindowHandle1);
        dev_close_window_if_open(hv_WindowHandle2);
      }
    ...
    HTuple hv_ObjectModel3DBox, HTuple hv_ObjectModel3DScene, HTuple hv_Score, HTuple hv_Pose)
{
  ...
  // Local control variables
  HTuple  hv_SampledEdges, hv_ReferencePoints, hv_SampledScene;
  HTuple  hv_BoxResultsDict, hv_AllBoxResultsDictKeys, hv_Labels;
  HTuple  hv_Index, hv_CurrResult, hv_CurrScore, hv_CurrLabel;
  HTuple  hv_Exception, hv_Instructions, hv_Colors, hv_Number;
  HTuple  hv_ObjectModel3DResult, hv_ColorsVis, hv_Message;
  HTuple  hv_PoseOut;

  //Get box finder data.
  GenEmptyObjectModel3d(&hv_SampledEdges);
  try
  {
    GetDictTuple(hv_BoxInformation, "sampled_edges", &hv_SampledEdges);
    GetDictTuple(hv_BoxInformation, "sampled_reference_points", &hv_ReferencePoints);
    GetDictTuple(hv_BoxInformation, "sampled_scene", &hv_SampledScene);
    GetDictTuple(hv_BoxInformation, "results", &hv_BoxResultsDict);
    GetDictParam(hv_BoxResultsDict, "keys", HTuple(), &hv_AllBoxResultsDictKeys);
    //
    hv_Labels = HTuple();
    {
    HTuple end_val10 = (hv_AllBoxResultsDictKeys.TupleLength())-1;
    HTuple step_val10 = 1;
    for (hv_Index=0; hv_Index.Continue(end_val10, step_val10); hv_Index += step_val10)
    {
      GetDictTuple(hv_BoxResultsDict, hv_Index, &hv_CurrResult);
      GetDictTuple(hv_CurrResult, "score", &hv_CurrScore);
      //
      hv_CurrLabel = "Score:   "+(hv_CurrScore.TupleString(".2f"));
      hv_Labels = hv_Labels.TupleConcat(hv_CurrLabel);
    }
    }
  }
  // catch (Exception) 
  ...
  //rigid_trans_object_model_3d (ObjectModel3DBox, Pose, ObjectModel3DResult)
  hv_ObjectModel3DResult = hv_ObjectModel3DBox;
  ...
  hv_Message[3] = "Reference points (yellow)";
  hv_Message[4] = ((hv_Number+" object")+HTuple((HTuple("s").Append(""))[int(hv_Number==1)]))+" found";
  visualize_object_model_3d(hv_WindowHandle1, ((hv_ObjectModel3DScene.TupleConcat(hv_SampledScene)).TupleConcat(hv_ReferencePoints)).TupleConcat(hv_ObjectModel3DResult), 
      ...
      hv_Message, ((HTuple("").Append("")).Append("")).TupleConcat(hv_Labels), hv_Instructions, 
      &hv_PoseOut);
    ...
    HTuple hv_Pose, HTuple hv_EdgesTrained, HTuple hv_VisibilityTrained)
{
  ...
  // Local control variables
  HTuple  hv_GenParamNames, hv_GenParamValues, hv_Use3DEdges;
  HTuple  hv_Exception, hv_SampledEdges, hv_KeyPoints, hv_SampledScene;
  HTuple  hv_Labels, hv_Index, hv_CurrScores, hv_CurrLabel;
  ...
  try
  {
    GetSurfaceMatchingResult(hv_SurfaceMatchingResultID, "param_names", 0, &hv_GenParamNames);
    GetSurfaceMatchingResult(hv_SurfaceMatchingResultID, "param_values", 0, &hv_GenParamValues);
    get_find_parameter(hv_GenParamNames, hv_GenParamValues, "use_3d_edges", "true", 
        &hv_Use3DEdges);
  }
  // catch (Exception) 
  catch (HException &HDevExpDefaultException)
  ...
  if (0 != (int(hv_Use3DEdges==1)))
  {
    hv_Use3DEdges = "true";
  }

  GenEmptyObjectModel3d(&hv_SampledEdges);
  if (0 != (HTuple(int(hv_EdgesTrained==HTuple("true"))).TupleAnd(int(hv_Use3DEdges==HTuple("true")))))
  {
    try
    {
  ...
  hv_Labels = HTuple();
  {
  HTuple end_val24 = (hv_Score.TupleLength())-1;
  HTuple step_val24 = 1;
  for (hv_Index=0; hv_Index.Continue(end_val24, step_val24); hv_Index += step_val24)
  {
    GetSurfaceMatchingResult(hv_SurfaceMatchingResultID, "all_scores", hv_Index, 
        &hv_CurrScores);
    hv_CurrLabel = "Total Score:   "+(HTuple(hv_CurrScores[0]).TupleString(".2f"));
    if (0 != (int((hv_CurrScores.TupleLength())>1)))
    {
      hv_CurrLabel = (hv_CurrLabel+"\nSurface Score: ")+(HTuple(hv_CurrScores[1]).TupleString(".2f"));
    }
    if (0 != (HTuple(HTuple(int((hv_CurrScores.TupleLength())>2)).TupleAnd(int(hv_Use3DEdges==HTuple("true")))).TupleAnd(int(hv_EdgesTrained==HTuple("true")))))
    {
      hv_CurrLabel = (hv_CurrLabel+"\n3D Edge Score: ")+(HTuple(hv_CurrScores[2]).TupleString(".2f"));
    }
    if (0 != (HTuple(HTuple(int((hv_CurrScores.TupleLength())>3)).TupleAnd(int(hv_Use3DEdges==HTuple("true")))).TupleAnd(int(hv_EdgesTrained==HTuple("true")))))
    {
      hv_CurrLabel = (hv_CurrLabel+"\n2D Edge Score: ")+(HTuple(hv_CurrScores[3]).TupleString(".2f"));
    }
    if (0 != (HTuple(int((hv_CurrScores.TupleLength())>4)).TupleAnd(int(hv_VisibilityTrained==HTuple("true")))))
    {
      hv_CurrLabel = (hv_CurrLabel+"\nView-based Score: ")+(HTuple(hv_CurrScores[4]).TupleString(".2f"));
    }
    hv_Labels = hv_Labels.TupleConcat(hv_CurrLabel);
  }
  }
  ...
  if (0 != (int(hv_EdgesTrained==HTuple("true"))))
  {
    ...
    visualize_object_model_3d(hv_WindowHandle1, (((hv_ObjectModel3DScene.TupleConcat(hv_SampledEdges)).TupleConcat(hv_SampledScene)).TupleConcat(hv_KeyPoints)).TupleConcat(hv_ObjectModel3DResult), 
        ...
        hv_Message, (((HTuple("").Append("")).Append("")).Append("")).TupleConcat(hv_Labels), 
  ...
  else
  {
    ...
    visualize_object_model_3d(hv_WindowHandle1, ((hv_ObjectModel3DScene.TupleConcat(hv_SampledScene)).TupleConcat(hv_KeyPoints)).TupleConcat(hv_ObjectModel3DResult), 
        HTuple(), HTuple(), (("color_"+HTuple::TupleGenSequence(0,hv_Number+2,1)).TupleConcat(HTuple("point_size_")+((HTuple(0).Append(1)).Append(2)))).TupleConcat((HTuple("disp_pose").Append("alpha"))), 
        (((HTuple("gray").Append("cyan")).Append("yellow")).TupleConcat(hv_ColorsVis)).TupleConcat(((((HTuple(1.0).Append(3.0)).Append(5.0)).Append("true")).Append(0.5))), 
        hv_Message, ((HTuple("").Append("")).Append("")).TupleConcat(hv_Labels), 
        hv_Instructions, &hv_PoseOut);
  }
  HDevWindowStack::SetActive(hv_WindowHandle1);
  if (HDevWindowStack::IsOpen())
    ...
    HTuple hv_CasesDone, HTuple hv_CurrentCase, HTuple hv_WindowScaling)
{
  ...
  HTuple  hv_MenuButtonColor, hv_Rows, hv_Cols, hv_Indices;
  HTuple  hv_Done, hv_Ascent, hv_Descent, hv_Width, hv_Height;
  HTuple  hv_Col, hv_Scale;
  ...
  for (hv_i=1; hv_i.Continue(end_val10, step_val10); hv_i += step_val10)
  {
    ...
    hv_MenuButtonColor = "#9a9a9aFF";
    SetColor(hv_WindowHandleMenu, hv_MenuButtonColor);
    HDevWindowStack::SetActive(hv_WindowHandleMenu);
    if (HDevWindowStack::IsOpen())
      SetDraw(HDevWindowStack::GetActive(),"fill");
    if (HDevWindowStack::IsOpen())
      SetColor(HDevWindowStack::GetActive(),hv_MenuButtonColor);
    ...
    {
      SetColor(hv_WindowHandleMenu, "#FBB900FF");
    }
    else if (0 != (HTuple(int(hv_Indices!=-1)).TupleAnd(int(hv_Indices!=HTuple()))))
    {
      SetColor(hv_WindowHandleMenu, "yellow");
      hv_Done = 1;
    }
    else
    {
      SetColor(hv_WindowHandleMenu, "navy");
    }
    GetStringExtents(hv_WindowHandleMenu, hv_Text, &hv_Ascent, &hv_Descent, &hv_Width, 
        &hv_Height);
    SetTposition(hv_WindowHandleMenu, (hv_Rows.TupleMin())+(8*hv_WindowScaling), 
        (((hv_Cols.TupleMax())+(hv_Cols.TupleMin()))/2)-(hv_Width/2));
    ...
    HTuple *hv_PoseEstimated)
{
  ...
  //This procedure estimates a visualization pose PoseEstimated
  //that can be used to visualize the ObjectModel3Dl
  //in the window specified with WindowHandle
  //with disp_object_model_3d or visualize_object_model_3d.
  //
  ...
  try
  {
    MomentsObjectModel3d(hv_ObjectModel3D, "principal_axes", &hv_Moments);
  }
  // catch (Exception) 
  catch (HException &HDevExpDefaultException)
  {
  ...
  //
  RigidTransObjectModel3d(hv_ObjectModel3D, hv_PoseInvert, &hv_ObjectModel3DRigidTrans);
...
void get_aggregated_models_diameter (HTuple hv_ObjectModel3DBox, HTuple *hv_ModelDiameterAggregated)
{
  ...
  // Local control variables
  HTuple  hv_ModelDiameter;

  GetObjectModel3dParams(hv_ObjectModel3DBox, "diameter", &hv_ModelDiameter);
  if (0 != (int(hv_ModelDiameter==HTuple())))
  {
    //if no box is found
    (*hv_ModelDiameterAggregated) = 0;
  }
  else
  {
    TupleMean(hv_ModelDiameter, &(*hv_ModelDiameterAggregated));
  }
  return;
}
    ...
    HTuple hv_GenParamValues, HTuple hv_ConvertBoolToInt, HTuple *hv_ParamValue)
{
  ...
  if (true)
  {
    ...
    if (0 != (HTuple(int(hv_Pos==-1)).TupleOr(int(hv_Pos==HTuple()))))
    {
  ...
  if (0 != (HTuple(int(hv_Pos!=HTuple())).TupleAnd(int(hv_Pos!=-1))))
  {
  ...
  {
    if (0 != (int((*hv_ParamValue)==HTuple("true"))))
    {
      (*hv_ParamValue) = 1;
    }
    if (0 != (int((*hv_ParamValue)==HTuple("false"))))
    {
      (*hv_ParamValue) = 0;
    }
  }
...
void get_max_min_amplitude (HTuple hv_BoxInformation, HTuple *hv_MaxMinAmplitude)
{
  ...
  // Local control variables
  HTuple  hv_GenParamDict, hv_InputLengths, hv_SideLengths;
  HTuple  hv_FactorConst;

  //Get input lengths.
  GetDictTuple(hv_BoxInformation, "gen_param", &hv_GenParamDict);
  GetDictTuple(hv_GenParamDict, "lengths", &hv_InputLengths);
  //Squaring avoids negative inputs to sqrt.
  hv_SideLengths.Clear();
  hv_SideLengths.Append(((HTuple(hv_InputLengths[0]).TuplePow(2))+(HTuple(hv_InputLengths[3]).TuplePow(2))).TupleSqrt());
  hv_SideLengths.Append(((HTuple(hv_InputLengths[3]).TuplePow(2))+(HTuple(hv_InputLengths[5]).TuplePow(2))).TupleSqrt());
  hv_SideLengths.Append(((HTuple(hv_InputLengths[0]).TuplePow(2))+(HTuple(hv_InputLengths[5]).TuplePow(2))).TupleSqrt());
  //
  hv_FactorConst = 3;
  if (0 != (int(HTuple(hv_InputLengths[5])>0)))
  {
    (*hv_MaxMinAmplitude) = hv_FactorConst*(hv_SideLengths.TupleMin());
  }
  else
  {
    (*hv_MaxMinAmplitude) = hv_FactorConst*HTuple(hv_SideLengths[0]);
  }
  return;
}
...
void get_min_amplitude (HTuple hv_BoxInformation, HTuple *hv_MinAmplitude)
{
  ...
  // Local control variables
  HTuple  hv_GenParamDict, hv_InputLengths, hv_PositiveIndices;
  HTuple  hv_PositiveLengths;

  //Get input lengths.
  GetDictTuple(hv_BoxInformation, "gen_param", &hv_GenParamDict);
  GetDictTuple(hv_GenParamDict, "lengths", &hv_InputLengths);
  //Ignore -1 lengths
  hv_PositiveIndices = (hv_InputLengths.TupleGreaterElem(0)).TupleFind(1);
  hv_PositiveLengths = HTuple(hv_InputLengths[hv_PositiveIndices]);
  //
  (*hv_MinAmplitude) = hv_PositiveLengths.TupleMin();
  return;
}
    ...
    HTuple *hv_FindValues)
{
  ...
  HTuple  hv_SceneFast, hv_SceneMLS, hv_SceneNormalsInverted;
  HTuple  hv_SceneNormalsToggled, hv_NormalCompMode, hv_Edges3DTrained;
  HTuple  hv_SceneHasMapping, hv_SceneHasNormals, hv_FastMethod;
  HTuple  hv_ModelNormalsInverted, hv_ModelNormalsToggled;
  HTuple  hv_Message, hv_MessageChanged, hv_ButtonPressed;
  HTuple  hv_Poses, hv_NXYZ, hv_MessageHandle, hv_Pose, hv_Score;
  HTuple  hv_Indices, hv_Row1, hv_Column1, hv_Row2, hv_Column2;
  HTuple  hv_TIT;
  HTupleVector  hvec_TI(1);
  ...
  estimate_visualization_pose_object_model_3d(hv_SampledModel, hv_WindowHandle1, 
      &hv_VC_P_Model);
  //
  //Visualization of the scene's normals
  estimate_visualization_pose_object_model_3d(hv_SampledScene, hv_WindowHandle2, 
      &hv_VC_P_Scene);
  //
  ...
  hv_Buttons[11] = "right";
  hv_Buttons[12] = "above_bottom";
  hv_Buttons[13] = -1;
  hv_Buttons[14] = -1;
  hv_Buttons[15] = "Invert Normals";
  hv_Buttons[16] = "left";
  hv_Buttons[17] = "bottom";
  hv_Buttons[18] = -1;
  hv_Buttons[19] = -1;
  hv_ShowNormals2 = 1;
  // Create a thread instance
  ...
  //
  //Cached scene normals
  hv_SceneFast = HTuple();
  hv_SceneMLS = HTuple();
  GetSurfaceMatchingResult(hv_SurfaceMatchingResultID, "scene_invert_normals", HTuple(), 
      &hv_SceneNormalsInverted);
  if (0 != (int(hv_SceneNormalsInverted==HTuple("true"))))
  {
    hv_SceneNormalsToggled = 1;
  }
  else
  {
    hv_SceneNormalsToggled = 0;
  }
  get_find_parameter(hv_GenParamNames, hv_GenParamValues, "scene_normal_computation", 
      "fast", &hv_NormalCompMode);
  GetSurfaceModelParam(hv_SurfaceModelID, "3d_edges_trained", &hv_Edges3DTrained);
  GetObjectModel3dParams(hv_ObjectModel3DScene, "has_xyz_mapping", &hv_SceneHasMapping);
  GetObjectModel3dParams(hv_ObjectModel3DScene, "has_point_normals", &hv_SceneHasNormals);
  if (0 != (HTuple(int(hv_Edges3DTrained==HTuple("true"))).TupleAnd(int(hv_SceneHasMapping==HTuple("true")))))
  {
  ...
  GetSurfaceMatchingResult(hv_SurfaceMatchingResultID, "model_invert_normals", HTuple(), 
      &hv_ModelNormalsInverted);
  if (0 != (int(hv_ModelNormalsInverted==HTuple("true"))))
  {
  ...
  if (0 != (hv_SceneNormalsToggled.TupleNot()))
  {
    hv_Message[2] = "Scene normals are not inverted (default)";
  }
  else
  {
    hv_Message[2] = "Scene normals are inverted";
  }
  if (0 != (int(hv_NormalCompMode==HTuple("fast"))))
  {
    hv_Message[3] = "Scene normals are computed based on the fast method "+hv_FastMethod;
  }
  else if (0 != (int(hv_NormalCompMode==HTuple("mls"))))
  {
    hv_Message[3] = "Scene normals are computed based on the mls method";
  }
  else
  {
    hv_Message[3] = "Scene normals are computed based on an unknown method";
  }
  hv_MessageChanged = 1;
  //
  do
  {
    ...
    else if (0 != (int(hv_ButtonPressed==1)))
    {
      ...
      EnqueueMessage(HTuple(hv_MessageQueues2[1]), hv_MessageHandle, HTuple(), HTuple());
      hv_SampledScene = hv_SceneFast;
      hv_Message[3] = "Scene normals are computed based on the fast method "+hv_FastMethod;
      hv_MessageChanged = 1;
      TupleFind((*hv_FindNames), "scene_normal_computation", &hv_Indices);
      if (0 != (int(hv_Indices!=-1)))
      {
        TupleRemove((*hv_FindNames), hv_Indices, &(*hv_FindNames));
        TupleRemove((*hv_FindValues), hv_Indices, &(*hv_FindValues));
      }
    }
    else if (0 != (int(hv_ButtonPressed==2)))
    {
      ...
      EnqueueMessage(HTuple(hv_MessageQueues2[1]), hv_MessageHandle, HTuple(), HTuple());
      hv_SampledScene = hv_SceneMLS;
      hv_Message[3] = "Scene normals are computed based on the mls method";
      hv_MessageChanged = 1;
      (*hv_FindNames) = (*hv_FindNames).TupleConcat("scene_normal_computation");
      (*hv_FindValues) = (*hv_FindValues).TupleConcat("mls");
    }
    else if (0 != (int(hv_ButtonPressed==3)))
    {
      //Invert Scene Normals
      GetObjectModel3dParams(hv_SampledScene, HTuple("point_normal_")+((HTuple("x").Append("y")).Append("z")), 
          &hv_NXYZ);
      SetObjectModel3dAttribMod(hv_SampledScene, HTuple("point_normal_")+((HTuple("x").Append("y")).Append("z")), 
          HTuple(), -hv_NXYZ);
      //Redraw to show the flipped normals
      CreateMessage(&hv_MessageHandle);
      SetMessageTuple(hv_MessageHandle, "type", "force_redraw");
      EnqueueMessage(HTuple(hv_MessageQueues2[1]), hv_MessageHandle, HTuple(), HTuple());
      hv_SceneNormalsToggled = hv_SceneNormalsToggled.TupleNot();
      //Update parameter display
      if (0 != (hv_SceneNormalsToggled.TupleNot()))
      {
        hv_Message[2] = "Scene normals are not inverted (default)";
        TupleFind((*hv_FindNames), "scene_invert_normals", &hv_Indices);
        if (0 != (int(hv_Indices!=-1)))
        {
          TupleRemove((*hv_FindNames), hv_Indices, &(*hv_FindNames));
          TupleRemove((*hv_FindValues), hv_Indices, &(*hv_FindValues));
      ...
      {
        hv_Message[2] = "Scene normals are inverted";
        (*hv_FindNames) = (*hv_FindNames).TupleConcat("scene_invert_normals");
        (*hv_FindValues) = (*hv_FindValues).TupleConcat("true");
      }
      hv_MessageChanged = 1;
    }
    ...
    if (0 != hv_MessageChanged)
    {
      ...
      write_note(hv_WindowHandleBufferMenu, "info", HTuple(hv_Message[2]));
      write_note(hv_WindowHandleBufferMenu, "none", HTuple(hv_Message[3]));
    ...
    HTuple hv_MinAmplitudeIn)
{
  ...
  // Local control variables
  HTuple  hv_SampledScene, hv_Exception, hv_SceneNormalsInverted;
  HTuple  hv_ObjectModel3DEdges, hv_DiameterModel, hv_EdgeDirs;
  HTuple  hv_ObjectModel3DEdgeDirs, hv_Instructions, hv_Message;
  HTuple  hv_PoseOut;
  ...
  {
    HDevExpDefaultException.ToHTuple(&hv_Exception);
    //Unable to extract -> create a dummy 3D object model instead
  }
  try
  {
    GetSurfaceMatchingResult(hv_SurfaceMatchingResultID, "scene_invert_normals", 
        HTuple(), &hv_SceneNormalsInverted);
    EdgesObjectModel3d(hv_ObjectModel3DScene, hv_MinAmplitudeIn, (HTuple("max_gap").Append("_scene_invert_normals")), 
        hv_MaxGapIn.TupleConcat(hv_SceneNormalsInverted), &hv_ObjectModel3DEdges);
    GetSurfaceModelParam(hv_SurfaceModelID, "diameter", &hv_DiameterModel);
  ...
  hv_Instructions[1] = "Zoom:   Shift + left mouse button";
  hv_Instructions[2] = "Move:   Ctrl  + left mouse button";
  hv_Message = "Inspect viewing and edge directions";
  //
  visualize_object_model_3d(hv_WindowHandle1, (hv_SampledScene.TupleConcat(hv_ObjectModel3DEdges)).TupleConcat(hv_ObjectModel3DEdgeDirs), 
      HTuple(), HTuple(), (((((HTuple("color_0").Append("color_1")).Append("color_2")).Append("disp_pose")).Append("disp_normals_1")).Append("disp_normals_2")), 
      (((((HTuple("gray").Append("green")).Append("red")).Append("true")).Append("true")).Append("true")), 
    ...
    HTuple hv_MaxGapIn, HTuple hv_MinAmplitudeAbsIn, HTuple *hv_MaxGap, HTuple *hv_MinAmplitudeAbs)
{
  ...
  HTuple  hv_MinMaxGap, hv_MaxMaxGap, hv_ObjectModel3DSceneSampled;
  HTuple  hv_SceneNormalsInverted, hv_ObjectModel3DEdges;
  HTuple  hv_Instructions, hv_Buttons, hv_MessageQueues1;
  HTuple  hv_PreviousState1, hv_DidFinish1, hv_MessageQueues2;
  HTuple  hv_MinAmplitudeRel, hv_XXScene, hv_YYScene, hv_ZZScene;
  HTuple  hv_PreviousState2, hv_ButtonPressed, hv_Poses, hv_DidFinish2;
  HTuple  hv_MessageHandle, hv_TIT;
  HTupleVector  hvec_TI(1);
  ...
  GetSurfaceMatchingResult(hv_SurfaceMatchingResultID, "scene_invert_normals", HTuple(), 
      &hv_SceneNormalsInverted);
  EdgesObjectModel3d(hv_ObjectModel3DScene, hv_DefaultAmplitude*hv_Diameter, (HTuple("max_gap").Append("_scene_invert_normals")), 
      hv_DefaultMaxGap.TupleConcat(hv_SceneNormalsInverted), &hv_ObjectModel3DEdges);
  //
  ...
  hcppthread_handle->SetInputCtrlParamTuple(7,hv_SceneNormalsInverted);
    ...
    HTuple *hv_MaxGapOut, HTuple *hv_MinAmplitude)
{
  ...
  // Local control variables
  HTuple  hv_GenParamDict, hv_DefaultAmplitude;
  HTuple  hv_MinMinAmplitude, hv_MaxMinAmplitude, hv_DefaultMaxGap;
  HTuple  hv_MappingSize, hv_MinMaxGap, hv_MaxMaxGap, hv_ObjectModel3DSceneSampled;
  HTuple  hv_ObjectModel3DEdgesSampled, hv_Instructions, hv_Buttons;
  HTuple  hv_MessageQueues1, hv_PreviousState1, hv_DidFinish1;
  HTuple  hv_MessageQueues2, hv_XXScene, hv_YYScene, hv_ZZScene;
  HTuple  hv_PreviousState2, hv_ButtonPressed, hv_Poses, hv_DidFinish2;
  HTuple  hv_MessageHandle, hv_TIT;
  HTupleVector  hvec_TI(1);
  ...
  //Get Dictionary with generic parameters.
  GetDictTuple(hv_BoxInformation, "gen_param", &hv_GenParamDict);
  //Prepare initial, minimal and maximal parameter values.
  //Get MinAmplitude parameter and prepare MinMinAmplitude and MaxMinAmplitude.
  GetDictTuple(hv_GenParamDict, "3d_edge_min_amplitude", &hv_DefaultAmplitude);
  if (0 != (int(hv_DefaultAmplitude==0.0)))
  {
    get_min_amplitude(hv_BoxInformation, &hv_DefaultAmplitude);
  }
  hv_MinMinAmplitude = 0.0001;
  get_max_min_amplitude(hv_BoxInformation, &hv_MaxMinAmplitude);
  //Get max_gap parameter and prepare MinMaxGap and MaxMaxGap.
  GetDictTuple(hv_GenParamDict, "max_gap", &hv_DefaultMaxGap);
  GetObjectModel3dParams(hv_ObjectModel3DScene, "mapping_size", &hv_MappingSize);
  hv_MinMaxGap = 0;
  hv_MaxMaxGap = hv_MappingSize.TupleMax();
  //
  //Get edges in scene with the Params used for the call to find_box_3d.
  GetDictTuple(hv_BoxInformation, "sampled_scene", &hv_ObjectModel3DSceneSampled);
  GetDictTuple(hv_BoxInformation, "sampled_edges", &hv_ObjectModel3DEdgesSampled);
  //
  //Start the 3D visualization window.
  hv_Instructions[0] = "Rotate: Left mouse button";
  hv_Instructions[1] = "Zoom:   Shift + left mouse button";
  ...
  // Set thread procedure call arguments 
  hcppthread_handle->SetInputCtrlParamTuple(0,hv_WindowHandle1);
  hcppthread_handle->SetInputCtrlParamTuple(1,hv_ObjectModel3DSceneSampled.TupleConcat(hv_ObjectModel3DEdgesSampled));
  hcppthread_handle->SetInputCtrlParamTuple(2,HTuple());
  hcppthread_handle->SetInputCtrlParamTuple(3,HTuple());
  hcppthread_handle->SetInputCtrlParamTuple(4,((HTuple("color_0").Append("color_1")).Append("disp_pose")));
  hcppthread_handle->SetInputCtrlParamTuple(5,((HTuple("gray").Append("red")).Append("true")));
  ...
  // Create a thread instance
  hcppthread_handle = new HDevThread(hcppthread_context,
              (void*)HDevExportCpp::_hcppthread_set_edge_parameter_sliders_find_box_3d,7,2);
  // Set thread procedure call arguments 
  hcppthread_handle->SetInputCtrlParamTuple(0,hv_WindowHandle2);
  hcppthread_handle->SetInputCtrlParamTuple(1,hv_ObjectModel3DScene);
  hcppthread_handle->SetInputCtrlParamTuple(2,hv_MessageQueues2);
  hcppthread_handle->SetInputCtrlParamTuple(3,hv_MessageQueues1);
  hcppthread_handle->SetInputCtrlParamTuple(4,(hv_MinMinAmplitude.TupleConcat(hv_MaxMinAmplitude)).TupleConcat(hv_DefaultAmplitude));
  hcppthread_handle->SetInputCtrlParamTuple(5,(hv_MinMaxGap.TupleConcat(hv_MaxMaxGap)).TupleConcat(hv_DefaultMaxGap));
  hcppthread_handle->SetInputCtrlParamTuple(6,hv_GenParamDict);
  hcppthread_handle->BindOutputCtrlParamTuple(0,0,&(*hv_MinAmplitude));
  hcppthread_handle->BindOutputCtrlParamTuple(1,0,&(*hv_MaxGapOut));
    ...
    HTuple *hv_MinAmplitude, HTuple *hv_MaxGap)
{
  ...
  HTuple  hv_WindowHandleBuffer, hv_PoseEstimated, hv_SliderHeight;
  ...
  HTuple  hv_ObjectModel3DEdges, hv_MessageHandle, hv_ValuesUpdated;
  HTuple  hv_MouseRow, hv_MouseColumn, hv_MouseButton, hv_Slider;
  HTuple  hv_UpdateSlider, hv_ValueRel, hv_MessageType, hv_Exception;
    ...
    try
    {
      while (true)
      {
        EdgesObjectModel3d(hv_ObjectModel3D, (*hv_MinAmplitude)*hv_ModelDiameter, 
            (HTuple("max_gap").Append("_scene_invert_normals")), (*hv_MaxGap).TupleConcat(hv_SceneNormalsInverted), 
    ...
    HTuple hv_MaxGapRange, HTuple hv_GenParamDict, HTuple *hv_MinAmplitude, HTuple *hv_MaxGap)
{
  ...
  HTuple  hv_RowSlider1, hv_RowSlider2, hv_ColSliderLabel;
  HTuple  hv_ColSliderValue, hv_ColSliderStart, hv_ColSliderEnd;
  HTuple  hv_ImgWidth, hv_ImgHeight, hv_Factor, hv_LensIn;
  HTuple  hv_MinScoreIn, hv_CurrentSliderActive, hv_ParamTmp;
  HTuple  hv_GrippingPoseTmp, hv_ScoreTmp, hv_ObjectModel3DBoxTmp;
  HTuple  hv_BoxInformationTmp, hv_ObjectModel3DEdges, hv_MessageHandle;
  HTuple  hv_ValuesUpdated, hv_MouseRow, hv_MouseColumn, hv_MouseButton;
  HTuple  hv_Slider, hv_UpdateSlider, hv_ValueRel, hv_MessageType;
  HTuple  hv_Exception;
  ...
  try
  {
    ...
    //
    //Estimate a good visualization pose.
    estimate_visualization_pose_simple(hv_ObjectModel3DScene, hv_WindowHandleBuffer, 
        &hv_PoseEstimated);
    //
    hv_SliderHeight = 25;
    hv_RowSlider1 = (hv_Height-10)-(2*hv_SliderHeight);
    ...
    DispObj(ho_ZZoomed, hv_WindowHandle);
    //
    GetDictTuple(hv_GenParamDict, "lengths", &hv_LensIn);
    GetDictTuple(hv_GenParamDict, "min_score", &hv_MinScoreIn);
    //
    hv_CurrentSliderActive = HTuple();
    try
    {
      while (true)
      {
        CreateDict(&hv_ParamTmp);
        SetDictTuple(hv_ParamTmp, "3d_edge_min_amplitude", (*hv_MinAmplitude));
        SetDictTuple(hv_ParamTmp, "max_gap", (*hv_MaxGap));
        SetDictTuple(hv_ParamTmp, "_return_edges", 1);
        SetDictTuple(hv_ParamTmp, "_abort_after_edge_extraction", 1);
        FindBox3d(hv_ObjectModel3DScene, hv_LensIn.TupleSelectRange(0,1), hv_LensIn.TupleSelectRange(2,3), 
            hv_LensIn.TupleSelectRange(4,5), hv_MinScoreIn, hv_ParamTmp, &hv_GrippingPoseTmp, 
            &hv_ScoreTmp, &hv_ObjectModel3DBoxTmp, &hv_BoxInformationTmp);
        GetDictTuple(hv_BoxInformationTmp, "edges", &hv_ObjectModel3DEdges);
        //
        //disp_object_model_3d (WindowHandleBuffer, ObjectModel3DEdges, [], PoseEstimated, 'color', 'blue')
        ClearWindow(hv_WindowHandleBuffer);
        DispObj(ho_ZZoomed, hv_WindowHandleBuffer);
        ...
        //
        disp_slider(hv_WindowHandleBuffer, hv_RowSlider1, hv_SliderHeight, hv_ColSliderLabel, 
            hv_ColSliderValue, hv_ColSliderStart, hv_ColSliderEnd, "MinAmplitude: ", 
            HTuple(hv_AmplitudeRange[0]), HTuple(hv_AmplitudeRange[1]), (*hv_MinAmplitude), 
            "2.3f");
        disp_slider(hv_WindowHandleBuffer, hv_RowSlider2, hv_SliderHeight, hv_ColSliderLabel, 
            hv_ColSliderValue, hv_ColSliderStart, hv_ColSliderEnd, "MaxGap: ", HTuple(hv_MaxGapRange[0]), 
    ...
    HTuple hv_ViewPoint)
{
  ...
  try
  {
    ...
    //Finalize Buttons
    {
    HTuple end_val317 = (hv_Buttons.TupleLength())-1;
    HTuple step_val317 = 5;
    for (hv_idx=0; hv_idx.Continue(end_val317, step_val317); hv_idx += step_val317)
    {
      ...
      else if (0 != (int(HTuple(hv_Buttons[hv_idx+2])==HTuple("above_bottom"))))
      {
        hv_Buttons[hv_idx+2] = (hv_Height-25)-(hv_ButtonHeight*2.5);
      }
    ...
    while (0 != (hv_Exit.TupleNot()))
    {
      ...
      {
      HTuple end_val463 = (hv_GenParamName.TupleLength())-1;
      HTuple step_val463 = 1;
      for (hv_I=0; hv_I.Continue(end_val463, step_val463); hv_I += step_val463)
      {
...
static void* _hcppthread_set_edge_parameter_sliders(void *hcthread)
{
  ...
  try
  {
    ...
    const HTuple        &cbhv_SceneNormalsInverted = hcppthread->GetInputCtrlParamTuple(7);
    ...
    set_edge_parameter_sliders(cbhv_WindowHandle, cbhv_ObjectModel3D, cbhv_MessageQueues, 
        ...
        cbhv_SceneNormalsInverted, &cbhv_MinAmplitude, &cbhv_MaxGap);
...
static void* _hcppthread_set_edge_parameter_sliders_find_box_3d(void *hcthread)
{
  ...
  try
  {
    // Input parameters
    const HTuple        &cbhv_WindowHandle = hcppthread->GetInputCtrlParamTuple(0);
    const HTuple        &cbhv_ObjectModel3DScene = hcppthread->GetInputCtrlParamTuple(1);
    const HTuple        &cbhv_MessageQueues = hcppthread->GetInputCtrlParamTuple(2);
    const HTuple        &cbhv_MessageQueueOut = hcppthread->GetInputCtrlParamTuple(3);
    const HTuple        &cbhv_AmplitudeRange = hcppthread->GetInputCtrlParamTuple(4);
    const HTuple        &cbhv_MaxGapRange = hcppthread->GetInputCtrlParamTuple(5);
    const HTuple        &cbhv_GenParamDict = hcppthread->GetInputCtrlParamTuple(6);

    // Output parameters
    HTuple        cbhv_MinAmplitude;
    HTuple        cbhv_MaxGap;

    // Call set_edge_parameter_sliders_find_box_3d
    set_edge_parameter_sliders_find_box_3d(cbhv_WindowHandle, cbhv_ObjectModel3DScene, 
        cbhv_MessageQueues, cbhv_MessageQueueOut, cbhv_AmplitudeRange, cbhv_MaxGapRange, 
        cbhv_GenParamDict, &cbhv_MinAmplitude, &cbhv_MaxGap);
