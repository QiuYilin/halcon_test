    ...
    HTuple hv_TranslationTolerance, HTuple *hv_Warnings)
{
  ...
  hv_IsHandEyeScara = HTuple(int(hv_Type==HTuple("hand_eye_scara_stationary_cam"))).TupleOr(int(hv_Type==HTuple("hand_eye_scara_moving_cam")));
  hv_IsHandEyeArticulated = HTuple(int(hv_Type==HTuple("hand_eye_stationary_cam"))).TupleOr(int(hv_Type==HTuple("hand_eye_moving_cam")));
  ...
  if (0 != hv_IsHandEyeArticulated)
  {
    ...
    {
      HDevExpDefaultException.ToHTuple(&hv_Exception);
      if (0 != (HTuple(int(hv_NumCameras!=0)).TupleAnd(int(hv_NumCalibObjs!=0))))
      {
  ...
  for (hv_Index1=0; hv_Index1.Continue(end_val162, step_val162); hv_Index1 += step_val162)
  {
    ...
    for (hv_Index2=hv_Index1+1; hv_Index2.Continue(end_val167, step_val167); hv_Index2 += step_val167)
    {
      ...
      while (0 != (int(hv_Rot1>(HTuple(180.0).TupleRad()))))
      {
        hv_Rot1 = hv_Rot1-(HTuple(360.0).TupleRad());
      }
      while (0 != (int(hv_Rot2>(HTuple(180.0).TupleRad()))))
      {
      ...
      while (0 != (int(hv_ErrorRot>(HTuple(180.0).TupleRad()))))
      {
      ...
      if (0 != (HTuple(int(hv_ErrorDualQuat0>hv_ToleranceDualQuat0)).TupleOr(int(hv_ErrorDualQuat4>hv_ToleranceDualQuat4))))
      {
  ...
  if (0 != (HTuple(int(hv_NumPairs<4)).TupleOr(int(hv_LargeRotationFraction<hv_MinLargeRotationFraction))))
  {
